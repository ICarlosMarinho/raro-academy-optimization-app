...
const breakpoints: number[] = [500, 600, 700, 800, 900, 1000, 1100, 1200, 1300, 1400, 1500];
...
export const ColorResponsive = () => {
  ...
  useEffect(() => {
    ...
    window.addEventListener("resize", () => {
      ...
      timeoutIdRef.current = setTimeout(alteraCor, 500);
    });
    return () => {
  ...
  return (
    <div className={classNames(color, "flex items-center justify-center w-screen h-screen bg-")}>
